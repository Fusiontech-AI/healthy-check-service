package org.fxkc.peis.rule.config;

import org.fxkc.peis.rule.function.SecondSimilarityFunction;
import org.fxkc.peis.rule.function.SimilarityFunction;
...
public class AviatorEvaluatorConfig {
    ...
    AviatorEvaluatorInstance evalEvaluatorInstance(@Value("${aviator.expression-cache-capacity:500}") int capacity) {
        ...
        evaluatorInstance.addFunction(new SimilarityFunction());
        evaluatorInstance.addFunction(new SecondSimilarityFunction());
