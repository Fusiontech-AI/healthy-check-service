...
/**
 * @author zj
 * @description: 福鑫科创his实现（交互通过集成平台接口）
 * @date 2024-02-01 18:10
 */

@Component
public class FusiontechHisJcptProvider implements HisProvider{
    @Override
    public boolean supportsHis(ServiceProviderEnum providerEnum) {
        return ServiceProviderEnum.FUSIONTECH_HIS_JCPT == providerEnum;
    }
    ...
    public JSONObject examination(ServiceProviderEnum providerEnum, Object... objects) {
        ...
        jsonObject.put("data", object+"his examination jcpt");
        return jsonObject;
    }
    ...
    public JSONObject checkIn(ServiceProviderEnum providerEnum, Object... objects) {
        String object = (String) objects[0];
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("data", object+"his checkIn jcpt");
        return jsonObject;
    }
    ...
    public JSONObject pushFees(ServiceProviderEnum providerEnum, Object... objects) {
        String object = (String) objects[0];
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("data", object+"his pushFees jcpt");
        return jsonObject;
    }
    ...
    public JSONObject charge(ServiceProviderEnum providerEnum, Object... objects) {
        String object = (String) objects[0];
        JSONObject jsonObject = new JSONObject();
        jsonObject.put("data", object+"his charge jcpt");
        return jsonObject;
    }
}
