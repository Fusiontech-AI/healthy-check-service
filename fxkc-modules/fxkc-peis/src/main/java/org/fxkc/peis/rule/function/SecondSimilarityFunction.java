...
public class SecondSimilarityFunction extends AbstractFunction {
    ...
    public AviatorObject call(Map<String, Object> env,
        ...
        if(StringUtils.isNotEmpty(splitSymbol)){
            ...
            for (int i = 0; i < split.length; i++) {
                ...
                if(similar> SimilarityCodeEnum.精度65.getCode()){
        ...
        return similar>SimilarityCodeEnum.精度65.getCode() ? AviatorBoolean.TRUE : AviatorBoolean.FALSE;
    }
    public String getName() {
        return "secondSimilarity.contains";
    }
