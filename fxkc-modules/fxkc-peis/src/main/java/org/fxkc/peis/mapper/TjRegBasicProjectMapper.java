...
public interface TjRegBasicProjectMapper extends BaseMapperPlus<TjRegBasicProject, TjRegBasicProjectVo> {
    ...
    @Select("select t1.* from tj_reg_basic_project t1 left join tj_basic_project t2 on t1.basic_project_id=t2.id where t1.reg_item_id =#{id} and t1.del_flag='0' order by t2.project_sort ")
