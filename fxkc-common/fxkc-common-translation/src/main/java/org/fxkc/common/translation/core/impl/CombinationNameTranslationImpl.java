 ...
 */
@AllArgsConstructor
@TranslationType(type = TransConstant.COMBINATION_ID_TO_NAME)
public class CombinationNameTranslationImpl implements TranslationInterface<String> {
    ...
    public String translation(Object key, String other) {
        return remoteTjCombinationProjectService.selectCombinationNameById((Long) key);
    }
}
